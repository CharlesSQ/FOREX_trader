...
class Strategy:
    ...
    def _get_signal(self, df, test=False):
        ...
        if df_copy['SMA20'].iloc[-1] > (df_copy['SMA50'].iloc[-1] + 0.00025) and df_copy['SMA50'].iloc[-1] > (df_copy['SMA400'].iloc[-1] + 0.0005):
        ...
        elif df_copy['SMA20'].iloc[-1] < (df_copy['SMA50'].iloc[-1] - 0.00025) and df_copy['SMA50'].iloc[-1] < (df_copy['SMA400'].iloc[-1] - 0.0005):
